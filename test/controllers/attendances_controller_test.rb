...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { End: @attendance.End, Hours: @attendance.Hours, Start: @attendance.Start } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { End: @attendance.End, Hours: @attendance.Hours, Start: @attendance.Start } }
