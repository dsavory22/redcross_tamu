...
class BudgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget" do
    assert_difference('Budget.count') do
      post budgets_url, params: { budget: { Date: @budget.Date, Total_amount: @budget.Total_amount } }
    end
  ...
  test "should update budget" do
    patch budget_url(@budget), params: { budget: { Date: @budget.Date, Total_amount: @budget.Total_amount } }
